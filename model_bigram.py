...
if __name__ == '__main__':
    ...
    DataHelper.save_submission('logregression2', log_prediction)
    ...
    DataHelper.save_submission('sgd2', sgd_prediction)
    ...
    DataHelper.save_submission('naive_bayes2', naive_prediction)
    ...
    DataHelper.save_submission('linearsvm2', linsvm_prediction)
    ...
    DataHelper.save_submission('svc2', svc_prediction)
    ...
    DataHelper.save_submission('xgb2', xgb_prediction)
